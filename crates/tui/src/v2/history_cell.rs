...
use crate::v2::diff_render::create_diff_summary;
use crate::v2::diff_render::display_path_for;
use crate::v2::exec_cell::CommandOutput;
use crate::v2::exec_cell::OutputLinesParams;
use crate::v2::exec_cell::TOOL_CALL_MAX_LINES;
use crate::v2::exec_cell::output_lines;
use crate::v2::exec_cell::spinner;
use crate::v2::exec_command::relativize_to_home;
use crate::v2::exec_command::strip_bash_lc_and_escape;
...
use crate::v2::render::line_utils::push_owned_lines;
...
use crate::v2::version::CLI_VERSION;
    ...
    fn format_directory_inner(directory: &Path, max_width: Option<usize>) -> String {
        ...
        if let Some(max_width) = max_width {
            ...
            if UnicodeWidthStr::width(formatted.as_str()) > max_width {
                return crate::v2::text_formatting::center_truncate_path(&formatted, max_width);
            }
        }
