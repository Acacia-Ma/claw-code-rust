...
use crate::v2::wrapping::line_contains_url_like;
use crate::v2::wrapping::line_has_mixed_url_and_non_url_tokens;
...
pub fn insert_history_lines<B>(
    terminal: &mut crate::v2::custom_terminal::Terminal<B>,
    lines: Vec<Line>,
) -> io::Result<()>
where
    B: Backend + Write,
...
mod tests {
    use super::*;
    use crate::v2::markdown_render::render_markdown_text;
    use crate::v2::test_backend::VT100Backend;
    ...
    fn vt100_blockquote_line_emits_green_fg() {
        ...
        let mut term =
            crate::v2::custom_terminal::Terminal::with_options(backend).expect("terminal");
