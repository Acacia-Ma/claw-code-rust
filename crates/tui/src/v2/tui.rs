...
use crate::v2::custom_terminal;
use crate::v2::custom_terminal::Terminal as CustomTerminal;
use crate::v2::tui::event_stream::EventBroker;
use crate::v2::tui::event_stream::TuiEventStream;
use crate::v2::tui::frame_requester::FrameRequester;
#[cfg(unix)]
use crate::v2::tui::job_control::SuspendContext;
...
pub(crate) const TARGET_FRAME_INTERVAL: Duration =
    crate::v2::tui::frame_rate_limiter::MIN_FRAME_INTERVAL;
...
impl Tui {
    pub fn new(terminal: Terminal) -> Self {
        ...
        let _ = crate::v2::terminal_palette::default_colors();
    ...
    fn flush_pending_history_lines(
        ...
        crate::v2::insert_history::insert_history_lines_with_mode(
            terminal,
            pending_history_lines.clone(),
            crate::v2::insert_history::InsertHistoryMode::new(is_zellij),
        )?;
