...
use crate::v2::color::is_light;
use crate::v2::color::perceptual_distance;
use crate::v2::exec_command::relativize_to_home;
use crate::v2::render::Insets;
use crate::v2::render::highlight::DiffScopeBackgroundRgbs;
use crate::v2::render::highlight::diff_scope_background_rgbs;
use crate::v2::render::highlight::exceeds_highlight_limits;
use crate::v2::render::highlight::highlight_code_to_styled_spans;
use crate::v2::render::line_utils::prefix_lines;
use crate::v2::render::renderable::ColumnRenderable;
use crate::v2::render::renderable::InsetRenderable;
use crate::v2::render::renderable::Renderable;
use crate::v2::terminal_palette::StdoutColorLevel;
use crate::v2::terminal_palette::XTERM_COLORS;
use crate::v2::terminal_palette::default_bg;
